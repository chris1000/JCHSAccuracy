...
function () {
   ...
   var s = (l.navigator || {}).userAgent,
      ...
      T = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "flip-both", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter"].concat(P.map(function (c) {
         return "".concat(c, "x")
   ...
   var I = H || {};
   I[V] || (I[V] = {}), I[V].styles || (I[V].styles = {}), I[V].hooks || (I[V].hooks = {}), I[V].shims || (I[V].shims = []);
   var D = I[V],
      W = [],
      Y = !1;

   function Q(c) {
      o && (Y ? setTimeout(c, 0) : W.push(c))
   }
   o && ((Y = (i.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(i.readyState)) || i.addEventListener("DOMContentLoaded", function c() {
      i.removeEventListener("DOMContentLoaded", c), Y = 1, W.map(function (c) {
         return c()
      })
   }));
   var K, G = "pending",
      ...
      $ = "rejected",
      cc = function () {},
      lc = "undefined" != typeof global && void 0 !== global.process && "function" == typeof global.process.emit,
      hc = "undefined" == typeof setImmediate ? setTimeout : setImmediate,
      zc = [];
   ...
   function tc(c, l) {
      c._state === G && (c._state = J, c._data = l, ac(rc, c))
   }

   function Mc(c, l) {
      c._state === G && (c._state = J, c._data = l, ac(nc, c))
   }
   ...
   function nc(c) {
      c._state = $, fc(c), !c._handled && lc && global.process.emit("unhandledRejection", c._data, c)
   }
   ...
   ic.prototype = {
      ...
      then: function (c, l) {
         ...
         return !l && !c || this._handled || (this._handled = !0, this._state === $ && lc && ac(Hc, this)), this._state === Z || this._state === $ ? ac(mc, h) : this._then.push(h), h.then
      },
      catch: function (c) {
      ...
      return new ic(function (h, c) {
         ...
         for (var a, m = 0; m < s.length; m++)(a = s[m]) && "function" == typeof a.then ? a.then(l(m), c) : z[m] = a;
         v || h(z)
      })
   }, ic.race = function (v) {
   ...
   function Lc(c) {
      if (c && o) {
         ...
         for (var h = i.head.childNodes, z = null, v = h.length - 1; - 1 < v; v--) {
            var a = h[v],
               m = (a.tagName || "").toUpperCase(); - 1 < ["STYLE", "LINK"].indexOf(m) && (z = a)
         }
   ...
   function bc(c) {
      return c.classList ? pc(c.classList) : (c.getAttribute("class") || "").split(" ").filter(function (c) {
         return c
      })
   }
   ...
   function wc(c) {
      return c.size !== Cc.size || c.x !== Cc.x || c.y !== Cc.y || c.rotate !== Cc.rotate || c.flipX || c.flipY
   }
   ...
   function xc(c) {
      var l = c.icons,
         ...
         o = [U.replacementClass, a ? "".concat(U.familyPrefix, "-").concat(a) : "", i].filter(function (c) {
      ...
      f && (V.attributes[B] = ""), e && V.children.push({
         tag: "title",
         attributes: {
            id: V.attributes["aria-labelledby"] || "title-".concat(dc())
         },
         children: [e]
      });
      var C, L, u, d, p, b, g, S, y, w, k, A, x, q, j, O, E, P, N, _, T, R, F, I = X({}, V, {
            prefix: v,
            iconName: a,
            main: h,
            mask: z,
         ...
         D = z.found && h.found ? (L = (C = I).children, u = C.attributes, d = C.main, p = C.mask, b = C.transform, g = d.width, S = d.icon, y = p.width, w = p.icon, k = kc({
            transform: b,
            containerWidth: y,
            iconWidth: g
         }), A = {
            ...
            children: [x]
         }, j = "mask-".concat(dc()), O = "clip-".concat(dc()), E = {
            tag: "defs",
            children: [{
               tag: "clipPath",
               attributes: {
         ...
         W = D.children,
         Y = D.attributes;
      return I.children = W, I.attributes = Y, s ? (N = (P = I).prefix, _ = P.iconName, T = P.children, R = P.attributes, F = P.symbol, [{
         tag: "svg",
         attributes: {
            style: "display: none;"
         },
   ...
   function qc(c) {
      ...
      wc(v) && (L.transform = (f = (M = {
         ...
         width: h,
         height: z
      }).transform, r = M.width, n = void 0 === r ? b : r, H = M.height, i = void 0 === H ? b : H, o = M.startCentered, C = "", C += (V = void 0 !== o && o) && p ? "translate(".concat(f.x / Vc - n / 2, "em, ").concat(f.y / Vc - i / 2, "em) ") : V ? "translate(calc(-50% + ".concat(f.x / Vc, "em), calc(-50% + ").concat(f.y / Vc, "em)) ") : "translate(".concat(f.x / Vc, "em, ").concat(f.y / Vc, "em) "), C += "scale(".concat(f.size / Vc * (f.flipX ? -1 : 1), ", ").concat(f.size / Vc * (f.flipY ? -1 : 1), ") "), C += "rotate(".concat(f.rotate, "deg) ")), L["-webkit-transform"] = L.transform);
      var u = yc(L);
   ...
   var jc = function () {},
      Oc = U.measurePerformance && M && M.mark && M.measure ? M : {
         mark: jc,
         measure: jc
      },
      Ec = 'FA "5.8.1"',
      Pc = function (c) {
         Oc.mark("".concat(Ec, " ").concat(c, " ends")), Oc.measure("".concat(Ec, " ").concat(c), "".concat(Ec, " ").concat(c, " begins"), "".concat(Ec, " ").concat(c, " ends"))
      },
      Nc = {
         begin: function (c) {
            return Oc.mark("".concat(Ec, " ").concat(c, " begins")),
               function () {
                  return Pc(c)
               }
         },
      ...
      _c = function (c, l, h, z) {
         var v, a, m, s, e, t = Object.keys(c),
            M = t.length,
            f = void 0 !== z ? (s = l, e = z, function (c, l, h, z) {
               return s.call(e, c, l, h, z)
            }) : l;
         for (m = void 0 === h ? (v = 1, c[t[0]]) : (v = 0, h); v < M; v++) m = f(m, c[a = t[v]], a, c);
         return m
      };
   var Tc = D.styles,
      Rc = D.shims,
   ...
   function Kc(c) {
      ...
      }, "").trim()), ">").concat(m.map(Kc).join(""), "</").concat(l, ">")
   }
   var Gc = function () {};
   ...
   var Zc = {
      ...
      nest: function (c) {
         var l = c[0],
            h = c[1];
         if (~bc(l).indexOf(U.replacementClass)) return Zc.replace(c);
   ...
   function cl(h, c) {
      ...
      if (0 === h.length) z();
         ...
         var l = $c;
         U.mutateApproach === w && (l = H.requestAnimationFrame || $c), l(function () {
            var c = !0 === U.autoReplaceSvg ? Zc.replace : Zc[U.autoReplaceSvg] || Zc.replace,
               l = Nc.begin("mutate");
            h.map(c), l(), z()
         })
      }
   ...
   function vl(c) {
      if (t && U.observeMutations) {
         var v = c.treeCallback,
            ...
            h = void 0 === l ? i : l;
         zl = new t(function (c) {
            ll || pc(c).forEach(function (c) {
               if ("childList" === c.type && 0 < c.addedNodes.length && !Jc(c.addedNodes[0]) && (U.searchPseudoElements && m(c.target), v(c.target)), "attributes" === c.type && c.target.parentNode && U.searchPseudoElements && m(c.target.parentNode), "attributes" === c.type && Jc(c.target) && ~_.indexOf(c.attributeName))
                  if ("class" === c.attributeName) {
                     var l = Uc(bc(c.target)),
                        h = l.prefix,
                        z = l.iconName;
   ...
   function ml(c) {
      var l, h, z = c.getAttribute("data-prefix"),
         ...
         m = Uc(bc(c));
      return z && v && (m.prefix = z, m.iconName = v), m.prefix && 1 < a.length ? m.iconName = (l = m.prefix, h = c.innerText, Ic[l][h]) : m.prefix && 1 === a.length && (m.iconName = Yc(m.prefix, al(c.innerText))), m
   }
   var sl = function (c) {
      var l = {
         size: 16,
   ...
   function el(c) {
      var l, h, z, v, a, m, s, e = ml(c),
         ...
         n = sl(c.getAttribute("data-fa-transform")),
         H = null !== (z = c.getAttribute("data-fa-symbol")) && ("" === z || z),
         i = (a = pc((v = c).attributes).reduce(function (c, l) {
            return "class" !== c.name && "style" !== c.name && (c[l.name] = l.value), c
         }, {}), m = v.getAttribute("title"), U.autoA11y && (m ? a["aria-labelledby"] = "".concat(U.replacementClass, "-title-").concat(dc()) : (a["aria-hidden"] = "true", a.focusable = "false")), a),
         o = (s = c.getAttribute("data-fa-mask")) ? Uc(s.split(" ").map(function (c) {
            return c.trim()
         })) : Bc();
      return {
         iconName: t,
   ...
   }(tl.prototype = Object.create(Error.prototype)).constructor = tl;
   var Ml = {
         fill: "currentColor"
      },
      fl = {
   ...
   function ol(v, a) {
      return new oc(function (c, l) {
         ...
         v && a && !U.showMissingIcons ? l(new tl("Icon is missing for prefix ".concat(a, " with icon name ").concat(v))) : c(h)
      })
   }
   var Vl = D.styles;

   function Cl(c) {
      var a, l, m, s, e, t, M, h, f, z = el(c);
      return ~z.extra.classes.indexOf(j) ? function (c, l) {
         ...
         return U.autoA11y && !h && (v.attributes["aria-hidden"] = "true"), oc.resolve([c, qc({
            content: c.innerHTML,
            width: a,
            height: m,
            transform: z,
      ...
      }(c, z) : (a = c, m = (l = z).iconName, s = l.title, e = l.prefix, t = l.transform, M = l.symbol, h = l.mask, f = l.extra, new oc(function (v, c) {
         oc.all([ol(m, e), ol(h.iconName, h.prefix)]).then(function (c) {
            var l = r(c, 2),
               h = l[0],
               z = l[1];
            v([a, xc({
   ...
   function Ll(c) {
      ...
      if (o) {
         var l = i.documentElement.classList,
            ...
            a = U.autoFetchSvg ? Object.keys(x) : Object.keys(Vl),
            m = [".".concat(j, ":not([").concat(B, "])")].concat(a.map(function (c) {
               return ".".concat(c, ":not([").concat(B, "])")
            })).join(", ");
         if (0 !== m.length) {
            var s = pc(c.querySelectorAll(m));
            if (0 < s.length) {
               z("pending"), v("complete");
               var e = Nc.begin("onTree"),
                  t = s.reduce(function (c, l) {
                     try {
                        var h = Cl(l);
                        h && c.push(h)
                     } catch (c) {
                        A || c instanceof tl && console.error(c)
                     }
                     return c
                  }, []);
   ...
   function dl(f, r) {
      ...
      return new oc(function (z, c) {
         ...
         var l = pc(f.children).filter(function (c) {
         ...
         if (v) {
            var m = h.getPropertyValue("content"),
               s = ~["Light", "Regular", "Solid", "Brands"].indexOf(v[1]) ? q[v[1].toLowerCase()] : E[a],
               e = Yc(s, al(3 === m.length ? m.substr(1, 1) : m));
            if (l && l.getAttribute(g) === s && l.getAttribute(S) === e) z();
            else {
               f.setAttribute(n, e), l && f.removeChild(l);
               var t = {
                     iconName: null,
                     title: null,
                     prefix: null,
                  ...
                  M = t.extra;
               M.attributes[u] = r, ol(e, s).then(function (c) {
                  var l = xc(X({}, t, {
                        icons: {
                           main: c,
                           mask: Bc()
   ...
   function pl(c) {
      return oc.all([dl(c, ":before"), dl(c, ":after")])
   }

   function bl(c) {
      return !(c.parentNode === document.head || ~k.indexOf(c.tagName.toUpperCase()) || c.getAttribute(u) || c.parentNode && "svg" === c.parentNode.tagName)
   }

   function gl(v) {
      if (o) return new oc(function (c, l) {
         var h = pc(v.querySelectorAll("*")).filter(bl).map(pl),
            z = Nc.begin("searchPseudoElements");
         ll = !0, oc.all(h).then(function () {
            z(), hl(), c()
         }).catch(function () {
            z(), hl(), l()
         })
   ...
   function yl() {
      ...
      if (h !== c || z !== l) {
         var a = new RegExp("\\.".concat(c, "\\-"), "g"),
            m = new RegExp("\\.".concat(l), "g");
         v = v.replace(a, ".".concat(h, "-")).replace(m, ".".concat(z))
      }
      return v
   }
   ...
   function xl(c) {
      var l = c.prefix,
         h = void 0 === l ? "fa" : l,
         z = c.iconName;
      if (z) return Qc(jl.definitions, h, z) || Qc(D.styles, h, z)
   }
   var ql, jl = new(function () {
         function c() {
            ! function (c, l) {
               ...
               Object.keys(v).forEach(function (c) {
                  l.definitions[c] = X({}, l.definitions[c] || {}, v[c]),
                     function c(l, z) {
                        ...
                        "function" != typeof D.hooks.addPack || v ? D.styles[l] = X({}, D.styles[l] || {}, a) : D.hooks.addPack(l, a), "fas" === l && c("fa", z)
                     }(c, v[c]), Wc()
               })
            }
         }, {
      ...
      El = {
         i2svg: function () {
            ...
            if (o) {
               ...
               return U.searchPseudoElements && gl(h), Ll(h, v)
            }
         ...
         watch: function () {
            ...
            !1 === U.autoReplaceSvg && (U.autoReplaceSvg = !0), U.observeMutations = !0, Q(function () {
               _l({
                  autoReplaceSvgRoot: l
               }), vl({
                  treeCallback: Ll,
                  nodeCallback: ul,
                  pseudoElementsCallback: gl,
      ...
      Pl = (ql = function (c) {
         ...
         if (c) {
            ...
            return Al(X({
               ...
               return kl(), U.autoA11y && (t ? n["aria-labelledby"] = "".concat(U.replacementClass, "-title-").concat(dc()) : (n["aria-hidden"] = "true", n.focusable = "false")), xc({
                  icons: {
                     main: wl(C),
                     mask: s ? wl(s.icon) : {
                        found: !1,
         ...
         var l = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
            h = (c || {}).icon ? c : xl(c || {}),
            z = l.mask;
         return z && (z = (z || {}).icon ? z : xl(z || {})), ql(h, X({}, l, {
            mask: z
         }))
      }),
      Nl = {
         noAuto: function () {
            U.autoReplaceSvg = !1, U.observeMutations = !1, zl && zl.disconnect()
         },
         config: U,
         dom: El,
         library: jl,
            ...
            return Al({
               ...
               return kl(), qc({
                  ...
                  extra: {
                     attributes: t,
                     styles: f,
                     classes: ["".concat(U.familyPrefix, "-layers-text")].concat(n(s))
                  }
               })
            })
         },
               ...
               return kl(),
                  function (c) {
                     ...
                     extra: {
                        attributes: s,
                        styles: t,
                        classes: ["".concat(U.familyPrefix, "-layers-counter")].concat(n(a))
                     }
                  })
            })
         },
      ...
      _l = function () {
         var c = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot,
            l = void 0 === c ? i : c;
         (0 < Object.keys(D.styles).length || U.autoFetchSvg) && o && U.autoReplaceSvg && Nl.dom.i2svg({
            node: l
         })
      };
   ! function (c) {
      ...
      f && (H.FontAwesome || (H.FontAwesome = Nl), Q(function () {
         _l(), vl({
            treeCallback: Ll,
            nodeCallback: ul,
            pseudoElementsCallback: gl
         ...
         addPack: function (c, l) {
            D.styles[c] = X({}, D.styles[c] || {}, l), Wc(), _l()
         },
         addShims: function (c) {
            var l;
            (l = D.shims).push.apply(l, n(c)), Wc(), _l()
         }
      })
   })
}();